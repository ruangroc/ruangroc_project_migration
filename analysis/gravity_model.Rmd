...
T_ij <- gravity_model(pop_estimates$year_2009, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
...
T_ij <- gravity_model(pop_estimates$year_2010, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
...
T_ij <- gravity_model(pop_estimates$year_2011, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
filename <- paste("alpha_",as.character(alpha_value), "_US1112.csv", sep = '')
write.csv(result, here("results", "gravity_model_results", filename), row.names = FALSE)

T_ij <- gravity_model(pop_estimates$year_2012, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
filename <- paste("alpha_",as.character(alpha_value), "_US1213.csv", sep = '')
write.csv(result, here("results", "gravity_model_results", filename), row.names = FALSE)

T_ij <- gravity_model(pop_estimates$year_2013, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
filename <- paste("alpha_",as.character(alpha_value), "_US1314.csv", sep = '')
write.csv(result, here("results", "gravity_model_results", filename), row.names = FALSE)

T_ij <- gravity_model(pop_estimates$year_2014, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
filename <- paste("alpha_",as.character(alpha_value), "_US1415.csv", sep = '')
write.csv(result, here("results", "gravity_model_results", filename), row.names = FALSE)

T_ij <- gravity_model(pop_estimates$year_2015, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
filename <- paste("alpha_",as.character(alpha_value), "_US1516.csv", sep = '')
write.csv(result, here("results", "gravity_model_results", filename), row.names = FALSE)

T_ij <- gravity_model(pop_estimates$year_2016, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
filename <- paste("alpha_",as.character(alpha_value), "_US1617.csv", sep = '')
write.csv(result, here("results", "gravity_model_results", filename), row.names = FALSE)

T_ij <- gravity_model(pop_estimates$year_2017, pop_estimates$fips, alpha_value)
result <- round(T_ij, 4)
