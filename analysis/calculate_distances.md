Calculate Distances Between States
================

Now it’s time to calculate the distances between states for each of the
dataframes we created for each year of migration data.
