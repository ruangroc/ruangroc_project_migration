...
Let's also define a function to attach the population estimates to each origin or destination fips. (We'll be calling this function in the data loading and cleaning process below).
```{r}
